...
<template>
  <div v-if="label === 'Mot de passe'" class="mb-3">
    ...
    <div class="input-group input-group-flat">
      <input v-if="showPassword" type="text" name="text" class="form-control" :placeholder="placeholder" v-model="password">
      <input v-else type="password" name="password" class="form-control" :placeholder="placeholder" v-model="password">
